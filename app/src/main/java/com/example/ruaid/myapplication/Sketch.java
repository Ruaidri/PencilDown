...
public class Sketch {
    /**
     * Invert a Copy of the bitmap. IE make the picture negative
     * Take that inverted copy and then blur it.
     * Blend the original copy and the inverted, blurred copy.
     * Now lower the contrast as the final step
     */
    ...
    public Bitmap changeToSketch(Bitmap bmp) {
        ...
        Invert =fastblur(bmp,1.000002f,5);
        Result = ColorDodgeBlend(Invert,Copy);
        Result = setBrightness(Result);
        return Result;
    }
    ...
    public Bitmap setBrightness(Bitmap picture) {
